...
<div class="head">
    <c:choose>
        ...
        <c:otherwise>
            ...
            <div class="sep20"></div>
            <button type="button" class="btn btn-primary btn-block cursor-pointer" style="width: 80%;margin:0 auto;" onclick="window.location.href = '/user.jhtml?type=<%= Constants.USER_SHOW_USER%>&id=${user.id}' "><i class="fa fa-user-circle" aria-hidden="true" ></i>&nbsp;&nbsp;用户中心</button>
